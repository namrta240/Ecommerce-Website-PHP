            ...
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-outline mb-4">
                        ...
                        autocomplete="off" require="required" name="user_username">
                    </div>
                    <!--email field-->
                    <div class="form-outline mb-4">
                        <label for="user_email" class="form-label">Email </label>
                        <input type="text" id="user_email" class="form-control" placeholder="Enter your email"
                        autocomplete="off" require="required" name="user_email">
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="file" id="user_image" class="form-control" 
                         require="required" name="user_image">
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        autocomplete="off" require="required" name="user_password">
                    </div>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        autocomplete="off" require="required" name="conf_user_password">
                    </div>
                     ...
                     <div class="form-outline mb-4">
                        ...
                        autocomplete="off" require="required" name="user_address">
                    </div>
                     ...
                     <div class="form-outline mb-4">
                        ...
                        autocomplete="off" require="required" name="user_contact">
                    </div>

                    <div class="mt-4 pt-2">
                        <input type="submit" value="Register" class="bg-info px-3 py-2 border-0" name="user_register">
                        <p class="small fw-bold mt-2 pt-2 mb-0">Already have an account ?<a href="user_login.php" 
